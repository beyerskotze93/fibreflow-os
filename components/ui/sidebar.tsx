...
export function Sidebar() {
  ...
  return (
    <aside className="hidden w-72 shrink-0 flex-col border-r border-zinc-800 bg-zinc-900 px-5 py-6 xl:flex">
      <div className="mb-10 flex items-center justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-slate-400">FibreFlow OS</p>
          <h1 className="text-2xl font-semibold text-white">Network Operations</h1>
        </div>
          ...
          return (
            <Link
              ...
              className={`group flex items-center gap-3 rounded-2xl px-4 py-3 text-sm transition ${
                active ? "bg-slate-800 text-white shadow shadow-slate-900" : "text-slate-300 hover:bg-slate-800 hover:text-white"
              }`}
            >
